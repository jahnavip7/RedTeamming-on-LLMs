...
async def test_agent_types(
    ...
    # for agent
    agent_test_settings.agent.agent_llm = "gpt-3.5-turbo"
    agent_test_settings.llm = "gpt-3.5-turbo"
    agent_test_settings.summary_llm = "gpt-3.5-turbo"
...
def test_settings_model_config() -> None:
    ...
    assert (
        llm_model.config["rate_limit"]["gpt-3.5-turbo"]
        == raw_settings["llm_config"]["rate_limit"]["gpt-3.5-turbo"]
    )
    assert (
        summary_llm_model.config["rate_limit"]["gpt-3.5-turbo"]
        == raw_settings["summary_llm_config"]["rate_limit"]["gpt-3.5-turbo"]
    )
    assert (
