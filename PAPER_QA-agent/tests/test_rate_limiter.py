...
LLM_CONFIG_W_RATE_LIMITS = [
    ...
    # where the user doesn't specify the model_list
    {
        "name": "gpt-3.5-turbo",
        "config": {
            "rate_limit": {"gpt-3.5-turbo": RateLimitItemPerSecond(20, 3)},
        },
    },
    {
        "name": "gpt-3.5-turbo",
        "config": {
            ...
            "rate_limit": {"gpt-3.5-turbo": RateLimitItemPerSecond(20, 1)},
        },
    },
    {
        "name": "gpt-3.5-turbo",
        "config": {
            ...
            "rate_limit": {"gpt-3.5-turbo": RateLimitItemPerSecond(1_000_000, 1)},
        },
    },
    {
        "name": "gpt-3.5-turbo",
...
async def test_rate_limit_on_run_prompt(
    ...
    if "rate_limit" in llm.config:
        max_tokens_per_second = (
            llm.config["rate_limit"]["gpt-3.5-turbo"].amount
            / llm.config["rate_limit"]["gpt-3.5-turbo"].multiples
        )
